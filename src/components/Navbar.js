...
export default function Navbar(props) {
  ...
  <label className="form-check-label" htmlfor="flexSwitchCheckDefault">Enable default dark mode</label>
</div>
        <div className={`form-check form-switch text-${props.red==='danger'?'light':'danger'}`}>
...
//P of proptypes should be always small
